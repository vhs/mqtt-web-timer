...
export default class Home extends Component {
    ...
    async loadConfig() {
        try {
            const response = await fetch('/config.json').then((res) =>
                res.json()
            )
    ...
    async setTimer() {
        ...
        const [hours, minutes] = this.state.timeInput
            .split(':')
            .map((x) => parseInt(x))
    ...
    async updateTimer(timer) {
        try {
            ...
            toast.success(
                'Timer has been set to ' + new Date(timer).toLocaleTimeString()
            )
        } catch (e) {
                                ...
                                <Col>
                                    <Row className='spacious'>
                                        <Col className='centered'>
                                            <p
                                                className={
                                                    styles.bumpInstructions
                                                }
                                            >
                                                If you need the time extended,
